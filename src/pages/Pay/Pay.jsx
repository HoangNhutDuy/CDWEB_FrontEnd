            ...
            <div className="responsive__cart-area">
              <form className="cart__form" onSubmit={handleSubmit}>
                <section className="cart__table table-responsive">
                  <h1 style={{ marginTop: 20, marginLeft: 15 }}>Thanh toán giỏ hàng</h1>
                  ...
                  <div className="section__cart__pay">
                    ...
                    <div className="section__cart__pay__container">
                      <div className="section__cart__pay__step2">
                        <div className="header__step2">2   PHƯƠNG THỨC VẬN CHUYỂN</div>
                        <div id="hr" />
                        <table>
                          <tbody>
                            <tr>
                              <td>
                                <input
                                  ...
                                  name="shippingMethod"
                                  value="storePickup"
                                  checked={formData.shippingMethod === "storePickup"}
                                  onChange={handleInputChange}
                                />
                              </td>
                              <td>0<u>đ</u></td>
                            ...
                            <tr>
                              <td>
                                <input
                                  ...
                                  checked={formData.shippingMethod === "standardShipping"}
                                  onChange={handleInputChange}
                                />
                              </td>
                              <td>0<u>đ</u></td>
                      ...
                      <div className="section__cart__pay__step3">
                        <div className="header__step3">3   PHƯƠNG THỨC THANH TOÁN</div>
                        <table>
                          <tbody>
                            <tr>
                              <td>
                    ...
                    <div className="section__cart__pay__step4">
                        ...
                        <tbody>
                          ...
                          {cartItems.map((item, index) => (
                            <tr key={index}>
                              ...
                              <td style={{ textAlign: "center" }}>{item.price * item.quantity} <u>đ</u></td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                      <table style={{ padding: "0px 10px" }}>
                        <tbody>
                          <tr>
                            <th style={{ textAlign: "start" }}>Thành tiền tạm tính</th>
                            <td style={{ textAlign: "right" }}>{totalAmount} <u>đ</u></td>
                          </tr>
                          <tr>
                            <th style={{ textAlign: "start" }}>Vận chuyển - Nhận hàng tại cửa hàng</th>
                            <td style={{ textAlign: "right" }}>0 <u>đ</u></td>
                          </tr>
                          <tr style={{ backgroundColor: "#f2f2f2" }}>
                            <th style={{ position: "relative", left: 10 }}>THÀNH TIỀN</th>
                            <td style={{ textAlign: "right", position: "relative", right: 2 }}>
                              <span id="section__cart__pay__step4__price">{totalAmount} <u>đ</u></span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div className="before__pay">
                    <button className="button__order" type="submit" style={{ backgroundColor: "#BE1E2D" }}>
                      Đặt hàng
                    </button>
                  </div>
                </section>
