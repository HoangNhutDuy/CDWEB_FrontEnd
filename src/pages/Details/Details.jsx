...
const Details = ({ match }) => {
  ...
  useEffect(() => {
    ...
    const fetchLatestProducts = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8080/product/latest-products`
        )
          ...
          <section id="section-detailsProduct">
            <div className="section__container__product">
              ...
              <div className="product-detail__center">
                ...
                >
                  <img src={productData.img} alt="product color" />
                  ...
                  >
                    ...
                    <li>
                      ...
                      <span className="in-stock">
                        Trong kho ({productData.stockQuantity} sản phẩm)
                      </span>
                    </li>
                  </ul>
                    ...
                    >
                      <li>
                        ...
                        <span style={{ color: "red" }}>
                          {productData.discountedPrice}đ.
                        </span>
                      </li>
                      <li>Tặng thêm cáp sạc 20cm Bagi</li>
                      <li>
                        Giảm thêm 30% Tối đa{" "}
                        <span style={{ color: "red" }}>600.000đ</span> khi mở
                        thẻ TPBank EVO
                      </li>
                    </ul>
                    <hr />
                ...
                <div className="product-detail__right">
                  ...
                  <p style={{ color: "#333333", fontSize: "14px" }}>
                    Bảo hành:<b>{productData.warrantyPeriod}</b> chính hãng{" "}
                    {productData.warrantyBrand}
                    <br />
                    12 tháng tại trung tâm bảo hành Chính hãng. 1 đổi 1 trong 30
            ...
            {relatestProducts.map((relatestProduct, index) => (
              <div className="product category__products" key={index}>
                <div className="product__header">
                  <img
                    src={relatestProduct?.img}
                    alt={relatestProduct?.title}
                  />
                </div>
